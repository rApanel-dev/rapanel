...
const variantClasses = {
    ...
    gold:         'bg-rapanel-gold/30 dark:bg-rapanel-gold/10 text-rapanel-gold border-rapanel-gold/40 dark:border-rapanel-gold/20 hover:bg-rapanel-gold hover:text-rapanel-navy-900',
...
<template>
    <button
        ...
        :disabled="disabled"
        :title="title"
        class="inline-flex items-center gap-1.5 rounded-lg font-bold border transition-all"
        :class="[
