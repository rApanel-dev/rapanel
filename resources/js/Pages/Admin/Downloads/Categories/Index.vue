...
const destroy = (id, name) => {
    askConfirm({
        ...
        message:      __('Are you sure? Downloads in this category will have no category.'),
        entity:       name,
        confirmLabel: __('Delete'),
        variant:      'danger',
        action:       () => router.delete(route('admin.download-categories.destroy', id)),
    });
};
</script>
