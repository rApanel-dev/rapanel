...
const submit = () => {
    form.post(safeRoute('admin.wiki.articles.store'), { forceFormData: true });
};
</script>
    ...
    <AdminLayout>
        <div class="max-w-4xl space-y-6">
            ...
            <div class="flex items-center gap-4 pb-5 border-b border-rapanel-navy-100 dark:border-white/[0.055]">
                <Link :href="safeRoute('admin.wiki.articles.index')" :aria-label="__('Back to Wiki Articles')"
                ...
                <div>
                    <h1 class="text-2xl font-display font-bold tracking-wide text-rapanel-text-light dark:text-white">{{ __('Create Wiki Article') }}</h1>
                    <nav class="flex items-center gap-1 text-xs mt-0.5">
                        <Link :href="safeRoute('admin.wiki.articles.index')" class="text-rapanel-text-light/45 dark:text-white/35 hover:text-rapanel-blue dark:hover:text-rapanel-blue transition-colors">{{ __('Wiki Articles') }}</Link>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-white dark:bg-rapanel-surface rounded-xl border border-rapanel-navy-100 dark:border-white/10 p-5 shadow-sm">
                        ...
                        <select v-model="form.section_id"
                            ...
                            <option value="" disabled>{{ __('Select a section...') }}</option>
                ...
                <div class="bg-white dark:bg-rapanel-surface rounded-xl border border-rapanel-navy-100 dark:border-white/10 p-5 shadow-sm">
                    ...
                    <!-- Picker + preview (solo cuando hay imagen) -->
                    <div v-if="imagePreview" class="mb-4 grid grid-cols-2 gap-3">

                        <!-- Imagen clicable para fijar focal point -->
                        <div class="space-y-1">
                        ...
                        <!-- Vista previa del recorte resultante -->
                        <div class="space-y-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white dark:bg-rapanel-surface rounded-xl border border-rapanel-navy-100 dark:border-white/10 p-5 shadow-sm flex items-center justify-between">
                        ...
                        <button type="button" role="switch" :aria-checked="form.show_toc" :aria-label="__('Show TOC')" @click="form.show_toc = !form.show_toc"
