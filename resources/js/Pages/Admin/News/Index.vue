                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="border-b border-rapanel-navy-100 dark:border-white/10 bg-rapanel-navy-50 dark:bg-white/5">
                                ...
                                <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-widest text-rapanel-text-light/50 dark:text-white/40 hidden lg:table-cell">Author</th>
                                <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-widest text-rapanel-text-light/50 dark:text-white/40 hidden lg:table-cell">Created</th>
                                <th class="px-4 py-3 text-left text-[10px] font-black uppercase tracking-widest text-rapanel-text-light/50 dark:text-white/40 hidden xl:table-cell">Updated</th>
                            ...
                            <tr v-for="item in news.data" :key="item.id"
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-center gap-1">
                                        <!-- View -->
                                        <ActionButton variant="blue" size="icon" title="View news"
                                        ...
                                        <!-- Edit -->
                                        <ActionButton variant="navy" size="icon" title="Edit news"
                                        ...
                                        <!-- Delete -->
                                        <ActionButton variant="danger" size="icon" title="Delete news"
