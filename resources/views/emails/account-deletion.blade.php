            ...
            <table cellpadding="0" cellspacing="0" border="0" width="600"
                ...
                <tr>
                    ...
                    <td width="210" valign="middle"
                        ...
                        <div style="width:210px; min-height:460px; font-size:0; line-height:0;">&nbsp;</div>
                    </td>
                    ...
                    <td valign="middle" style="padding:40px 32px; background-color:#ffffff;">
                        ...
                        <!-- Nombre del servidor -->
                        <p style="margin:0 0 4px 0; font-size:11px; font-weight:800; color:#E74C3C;
                        ...
                        <!-- Cuerpo -->
                        <p style="margin:0 0 20px 0; font-size:13px; color:#4b5563; line-height:1.7;
                                  font-family:Arial, Helvetica, sans-serif;">
                            {{ __('account_deletion_body') }}
                        </p>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:22px;">
                            <tr>
                                <td bgcolor="#f8fafc"
                                    ...
                                    <p style="margin:0 0 4px 0; font-size:11px; font-weight:700; color:#6b7280;
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:22px;">
                            <tr>
                                <td bgcolor="#fef2f2"
                                    style="background-color:#fef2f2; border-left:4px solid #E74C3C;
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
                            <tr>
                                <td>
                                    <a href="{{ $url }}"
                                       style="display:inline-block; background-color:#E74C3C; border-radius:8px;
                                              padding:12px 28px; font-size:14px; font-weight:700; color:#ffffff;
                                              text-decoration:none; font-family:Arial, Helvetica, sans-serif;">
                                        {{ __('account_deletion_confirm') }}
                                    </a>
                                </td>
                            </tr>
                        </table>
